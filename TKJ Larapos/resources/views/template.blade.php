                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <a href="#"><i class="fa fa-dashboard fa-fw"></i> Brand</a>
                            <a href="#"><i class="fa fa-dashboard fa-fw"></i> Category</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Forms<span class="fa arrow"></a>
